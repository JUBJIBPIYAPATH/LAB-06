...
<hr>เมื่อทำการพิมเข้าไปหลายๆตัวก็ะแสดงผลแค่ตัวอักษรตัวแรกเท่านั้นตัวอื่นๆหลังตัวแรกไม่แสดงเพราะเราประกาศตัวแปลรับค่า ch มาแค่าตัวเดียว
<hr>
<hr>
<hr>
<hr>
...
<hr>ก็ยังสามารถรันได้แต่ยังมี Error ซึงเวลาแสดงผลการทำงานมันทำให้แสดงค่าkeyที่keyเข้าออกมา 2 ตัวอักษรแรกที่พิมพ์เข้าไป
<hr>
<hr>
<hr>
<hr>
