...
<hr>![](https://github.com/JUBJIBPIYAPATH/LAB-06/blob/master/LAB6.1.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
<hr>เมื่อทำการพิมเข้าไปหลายๆตัวก็ะแสดงผลแค่ตัวอักษรตัวแรกเท่านั้นตัวอื่นๆหลังตัวแรกไม่แสดงเพราะเราประกาศตัวแปลรับค่า ch มาแค่ตัวเดียว
<hr>
<hr>
<hr>
<hr>
...
<hr>เมื่อเราทำการตัด (char) จะทำError เพราะมันไม่รู้จักว่า ch=Console.Read(); คือตัวแปรอะไรที่จะต้องรับค่ามาอ่านแล้วต้องนำไปแสดงผล
<hr>ปล.ถ้าเราทำแล้วมันยังแสดงผลออกมาได้แสดงว่ามันกลับไปรันโปรแกรมการทำงานก่อนหน้าที่เราจะการตัด(char)ออกไป
<hr>
<hr>
<hr>
<hr>
...
<hr>![](https://github.com/JUBJIBPIYAPATH/LAB-06/blob/master/LAB6.3.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
<hr>ถ้าป้อนตัวเลขเข้าไปจะทำให้มัน Error เพราะมันไม่รู้จักตัวอักษร
<hr>วิธีแก้ามรูปภาพนะครับ
<hr>![](https://github.com/JUBJIBPIYAPATH/LAB-06/blob/master/LAB6.4.PNG?raw=true)
<hr>
<hr>
<hr>
...
<hr>ถ้าป้อนตัวอักษรเข้าจะทำให้มัน Error เพราะมันไม่รู้จักตัวอักษรแล้วเราก็ประกาศตัวแปล int เลยไม่อ่านค่าตัวอักษร
<hr>ซึงทำให้มันเหมือนโปรแกรมก่อนหน้านี้ที่อ่านค่าเฉพาะตัวเลข
<hr>
<hr>
<hr>
<hr>
...
![](https://github.com/JUBJIBPIYAPATH/LAB-06/blob/master/LAB6.6.PNG?raw=true)
